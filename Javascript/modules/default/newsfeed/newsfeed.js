...
Module.register("newsfeed", {
	...
	defaults: {
		feeds: [ //this does literally nothing, edit in config instead to get news.
			{
				title: "All Sides",
			...
			{
				title: "Coindesk",
				url: "http://www.coindesk.com/arc/outboundfeeds/rss/?outputType=xml",
				encoding: "UTF-8" //ISO-8859-1
			}
		...
		ignoreOldItems: true,
		ignoreOlderThan: 96 * 60 * 60 * 1000, // 4 day
		removeStartTags: "",
		removeEndTags: "",
		startTags: [],
		endTags: [],
